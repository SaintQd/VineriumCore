...
@MythicCondition(author = "SaintQd", name = "vinstringstartswith")
class VinStringStartsWithCondition(event : MythicConditionLoadEvent) : IEntityCondition, ILocationCondition, ISkillMetaComparisonCondition {
    ...
    override fun check(target: AbstractEntity): Boolean {
        ...
        return compare1.startsWith(compare2)
    }
